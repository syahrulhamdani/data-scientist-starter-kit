...
# **Kuis:** Sebagai pekerja lepas, pemasukan tiap bulan saya tidak tentu. Bulan Januari kemairn saya mendapat pemasukan sebesar 1 juta rupiah, Februari Rp 500.000,-, dan Rp 800.000,- di bulan Maret. Berapa rata-rata pendapatan saya pada kuartal pertama di tahun ini?
# ```
# 
# Silakan ketik respon kamu di dalam cell di bawah ini ⬇
# 
# > Ketik di dalam fungsi `print` dan mengganti `# KETIK DI SINI` dengan jawaban. Setelah ini, silakan masukkan jawaban dari setiap kuis dengan mengganti `# KETIK DI SINI` dengan jawaban kamu, bisa dalam satu baris atau lebih.
